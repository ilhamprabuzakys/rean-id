! function () {
	...
	function u() {
		var t, e, a;
		eva.replace();
		console.log("Assets berhasil dimuat, menjalankan aplikasi pada url : " + getBaseUrl());
		window.sessionStorage && ((t = sessionStorage.getItem("is_visited")) ? null !== (e = document.querySelector("#" + t)) && (e.checked = !0,
			...
			1 == document.getElementById("layout-direction-ltr").checked && "layout-direction-ltr" === a ? (document.getElementsByTagName("html")[0].removeAttribute("dir"),
				...
				document.getElementById("bootstrap-style").setAttribute("href", getBaseUrl() + "/assets/borex/css/bootstrap.min.css"),
				document.getElementById("app-style").setAttribute("href", getBaseUrl() + "/assets/borex/css/app.min.css"),
	...
	window.onload = function () {
		...
		function () {
			...
			t && t.forEach(function (t) {
				...
				// console.log(e, a, s, n, o, l);
				// console.log('window: ' + window.location.href.split(/[?#]/)[0]);
				t.href == l && (t.classList.add("active"), (e = t.parentElement) && "side-menu" !== e.id && (e.classList.add("mm-active"), (a = e.parentElement) && "side-menu" !== a.id && (a.classList.add("mm-show"), a.classList.contains("") && console.log("has "), (s = a.parentElement) && "side-menu" !== s.id && (s.classList.add("mm-active"), (n = s.parentElement) && "side-menu" !== n.id && (n.classList.add("mm-show"), (o = n.parentElement) && "side-menu" !== o.id && o.classList.add("mm-active"))))))
			})
		...
		function () {
			...
			t.addEventListener("change", function (t) {
				t && t.target && t.target.value && ("ltr" == t.target.value ? (document.getElementsByTagName("html")[0].removeAttribute("dir"), document.getElementById("bootstrap-style").setAttribute("href", "http://rean-id.test/assets/borex/css/bootstrap.min.css"), document.getElementById("app-style").setAttribute("href", "http://rean-id.test/assets/borex/css/app.min.css"), sessionStorage.setItem("is_visited", "layout-direction-ltr")) : (document.getElementById("bootstrap-style").setAttribute("href", "http://rean-id.test/assets/borex/css/bootstrap.min.css"), document.getElementById("app-style").setAttribute("href", "http://rean-id.test/assets/borex/css/app.min.css"), document.getElementsByTagName("html")[0].setAttribute("dir", "rtl"), sessionStorage.setItem("is_visited", "layout-direction-rtl")))
			})
