		...
		return function() {
			...
			var b = ["rtl", "style", "layoutType", "layoutMenuFlipped", "showDropdownOnHover", "layoutNavbarFixed", "layoutFooterFixed", "themes"],
				...
				E = function() {
						...
						value: function(t) {
							...
							if (this._hasControls("themes")) {
								...
								if (i) {
									...
									var o, a, n, l = this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", t + ("light" !== this.settings.style ? "-".concat(this.settings.style) : "")));
									this._loadStylesheets((o = {}, a = l, n = document.querySelector(".template-customizer-theme-css"), (a = v(a)) in o ? Object.defineProperty(o, a, {
										value: n,
										enumerable: !0,
										configurable: !0,
										writable: !0
									}) : o[a] = n, o), s || function() {}), e && this.settings.onSettingsChange.call(this, this.settings)
								}
							}
						}
					}, {
					...
					}], s && g(e.prototype, s), Object.defineProperty(e, "prototype", {
						writable: !1
					}), t
				}();
			E.THEMES = [{
