...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")),
	function() {
		...
		}), window.Helpers.isLightStyle() ? (n && (n.querySelector("i").classList.add("mdi-weather-night"), new bootstrap.Tooltip(n, {
			title: "Dark mode",
			fallbackPlacements: ["bottom"]
		})), o("light")) : (n && (n.querySelector("i").classList.add("mdi-weather-sunny"), new bootstrap.Tooltip(n, {
			title: "Light mode",
			fallbackPlacements: ["bottom"]
		})), o("dark"))) : n.parentElement.remove(), "undefined" != typeof i18next && "undefined" != typeof i18NextHttpBackend && i18next.use(i18NextHttpBackend).init({
			lng: "en",
			debug: !1,
			fallbackLng: "en",
			backend: {
		...
		n.length && n.on("click", function() {
			...
			o.hasClass("container-xxl") && o.find(".twitter-typeahead").addClass("container-xxl")
