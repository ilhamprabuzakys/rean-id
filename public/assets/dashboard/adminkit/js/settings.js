			...
			const c = () => {
				...
				h = (t, e) => {
					if ("theme" === t) {
						...
						document.querySelector(".js-stylesheet").setAttribute("href", "/assets/dashboard/adminkit/css/".concat(t, ".css")), a && a !== t && window.location.replace(window.location.pathname), a = t
					}
