<section class="position-relative bg-body-tertiary overflow-hidden">
     <svg class="w-100 position-absolute start-0 bottom-0 z-1 mb-n1 rotate-y" height="48" fill="#000"
       ...
       <div class="row align-items-center">
           <div class="col-lg-5 mb-7 mb-lg-0">
               ...
               <div class="d-flex flex-column flex-md-row align-items-md-center" data-aos="fade-up">
                   <span class="me-md-4 mb-3 mb-md-0">
                       <a href="{{ asset('index-landing-business.html#!') }}" class="btn btn-primary">Contact us</a>
                   </span>
           ...
           <div class="col-lg-6 ms-auto">
               <div class="position-relative pe-7 pb-7" data-aos="fade-up">
                   ...
                   <!--Image-->
                   <div class="bg-mask">
                       <img src="{{ asset('assets/landing/assan/assets/img/960x900/2.jpg') }}" alt="" class="mask-image mask-blob-3">
                   </div>
               </div>
           </div>
       </div>
   </div>
    <svg class="w-100 position-absolute start-0 top-0 z-1 mb-n1" height="48" fill="#000"
            preserveAspectRatio="none" viewBox="0 0 1200 120" xmlns="http://www.w3.org/2000/svg"
            style="transform: rotate(180deg) scaleX(-1);color:var(--bs-body-bg)">
            <path
                d="M0 0v46.29c47.79 22.2 103.59 32.17 158 28 70.36-5.37 136.33-33.31 206.8-37.5 73.84-4.36 147.54 16.88 218.2 35.26 69.27 18 138.3 24.88 209.4 13.08 36.15-6 69.85-17.84 104.45-29.34C989.49 25 1113-14.29 1200 52.47V0z"
