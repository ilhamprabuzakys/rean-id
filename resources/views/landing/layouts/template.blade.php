...
<body>
   ...
   <a class="whatsapp-ico"
      onclick="shareToWhatsApp('Halo, saya tertarik dengan komunitas ini, bisa izinkan saya untuk bergabung dengan Anda!')">
   ...
   <script src="{{ asset('assets/landing/assan/assets/js/custom.js') }}"></script>
