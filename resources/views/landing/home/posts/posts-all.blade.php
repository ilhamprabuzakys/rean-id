      ...
      <div class="row pb-7 pt-lg-9 align-items-center">
         <div class="col-12 col-lg-12 mb-5 mb-lg-0">
            <ol class="breadcrumb mb-3">
               ...
               <li class="breadcrumb-item active fw-bold" aria-current="page">{{ __('Daftar Postingan') }}</li>
            </ol>
            <h2 class="display-2 mb-4">
               {{ __('Daftar Postingan') }}
            </h2>
            <p class="lead mb-0">
               {{ __('Berisi semua data postingan dengan berbagai tipe postingan yang ada.') }}
            </p>
         </div>
      </div>
      <!--/.row-->
...
<livewire:landing.posts.post-all />
@endsection