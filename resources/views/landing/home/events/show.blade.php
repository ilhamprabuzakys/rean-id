        ...
        <div class="row pt-3 pt-lg-9 pb-4 justify-content-between align-items-center">
            <div class="col-xl-8 mb-5 mb-xl-0">
                ...
                <h1 class="display-2 fw-bold mb-0">
                    Pembagian sembako dan Makan bersama
                </h1>
            </div>
            <div class="col-xl-4">
                <div class="d-flex align-items-center justify-content-xl-end">
                    ...
                    <div class="dropdown text-end">
                        <a href="{{ asset('demo-real-estate-listing.html#') }}" data-bs-toggle="dropdown"
                            class="btn btn-primary dropdown-toggle">
                            <i class="bx bx-share-alt fs-4 me-2"></i>
                            Bagikan
                        </a>
                        <div class="dropdown-menu dropdown-menu-end mt-2">
                            <a href="{{ asset('demo-real-estate-listing.html#!') }}" class="dropdown-item">
        ...
        <div class="row mb-3">
            <div class="col-md-6 mb-7 mb-md-0">
                ...
                <p>
                    ...
                    for previewing layouts and visual mockups the
                    90s as desktop publishers bundled the text with
                    their software. Today it's seen all around the
                    web; on templates, websites, and stock designs.
                    Use our generator to get your own, or read on
                ...
                <div class="d-flex align-items-center">
                    <div class="me-4">
                        <img src="{{ asset('assets/landing/assan/assets/img/avatar/12.jpg') }}"
                            class="img-fluid avatar xl rounded-circle" alt="" />
                    </div>
                    <div class="flex-grow-1">
                        <h6 class="mb-1">Abdul Tohir</h6>
                        <p class="small mb-1 text-body-secondary">
                            <i class="bx bxs-phone"></i> +62
                            123-4567-890
                        </p>
                        <p class="mb-0">
                            <a href="{{ asset('demo-real-estate-listing.html#!') }}"
                                class="link-hover-underline">Penyelenggara</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 mb-4 col-sm-12">
                        ...
                        <h5 class="mt-1 mb-0 pb-4 border-bottom">
                            April 10, 2021 3:08 PM - April 12, 2021 3:08 PM
                        </h5>
                    </div>
                    <div class="col-sm-4 mb-4 col-6">
                        <small class="text-body-secondary block">Durasi:</small>
                        <h5 class="lead mb-0 pb-4 border-bottom">3 hari</h5>
                    </div>
                    <div class="col-sm-4 mb-4 col-6">
                    ...
                    <div class="col-sm-12 mb-4 col-12">
                        ...
                        <h5 class="lead mb-0 pb-4 border-bottom">Jl. Moh Toha no 77, Kec. Cigereleng, Kota Bandung, Jawa
                            Barat Indonesia 40285.</h5>
                    </div>
                    <div class="col-sm-4 mb-4 col-6">
                        <small class="text-body-secondary">Status:</small>
                        <a class="badge px-2 py-1 ms-2 d-inline badge-soft-primary">Berlangsung</a>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
...
<section class="mb-4">
    <div class="container position-relative">
        <h3 class="mb-3 border-bottom pb-3">Foto Lokasi Event</h3>
        <div class="row">
            <div class="col-sm-6 mb-4">
                <a href="{{ asset('assets/landing/assan/assets/img/estate/listing/detail1.jpg') }}" data-glightbox
                    data-gallery="gallery02" class="d-block">
                    <img src="{{ asset('assets/landing/assan/assets/img/estate/listing/detail1.jpg') }}"
                        class="img-fluid rounded-4 shadow-lg" alt="" />
                </a>
            </div>
            <div class="col-6 mb-4">
                <a href="{{ asset('assets/landing/assan/assets/img/estate/listing/detail2.jpg') }}" data-glightbox
                    data-gallery="gallery02" class="d-block">
                    <img src="{{ asset('assets/landing/assan/assets/img/estate/listing/detail2.jpg') }}"
                        class="img-fluid rounded-4 shadow-lg" alt="" />
                </a>
            </div>
            <div class="col-6 mb-4">
                <a href="{{ asset('assets/landing/assan/assets/img/estate/listing/detail3.jpg') }}" data-glightbox
                    data-gallery="gallery02" class="d-block">
                    <img src="{{ asset('assets/landing/assan/assets/img/estate/listing/detail3.jpg') }}"
                        class="img-fluid rounded-4 shadow-lg" alt="" />
                </a>
            </div>
            <div class="col-sm-6 mb-4">
                <a href="{{ asset('assets/landing/assan/assets/img/estate/listing/detail4.jpg') }}" data-glightbox
                    data-gallery="gallery02" class="d-block">
                    <img src="{{ asset('assets/landing/assan/assets/img/estate/listing/detail4.jpg') }}"
                        class="img-fluid rounded-4 shadow-lg" alt="" />
                </a>
            </div>
        </div>
                ...
                <div class="position-relative">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3 border-start border-end" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="" data-bs-original-title="Bathrooms">
                                <div class="d-flex align-items-center">
...
<script>
   ...
   var initialLatitude = '-7.426529221326';
   var initialLongitude = '109.25107106566';
   var map = L.map('map', {
      layers: street
