      ...
      <div class="row pb-7 pt-lg-9 align-items-center">
         <div class="col-12 col-lg-7 mb-5 mb-lg-0">
            <ol class="breadcrumb mb-3">
               ...
               <li class="breadcrumb-item active" aria-current="page">Website Analisis</li>
            </ol>
            {{-- <h2 class="display-2 mb-4">
               {{ __('Daftar Postingan') }}
            </h2> --}}
            <h1 class="mb-0 display-3">Daftar Website Analisis</h1>
            <p class="lead mb-0">
               Berisi semua data postingan dengan tipe Website Analisis.
            </p>
         </div>
      </div>
      <!--/.row-->
