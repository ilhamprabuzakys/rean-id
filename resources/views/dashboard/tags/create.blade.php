...
@section('content')
   ...
   <h4 class="fw-bold py-3 mb-4">
      ...
      <a class="text-muted fw-light" href="{{ route('categories.index') }}">Daftar Label /</a>
      Tambah Label
   </h4>
   <!-- end page title -->
   <div class="row">
            ...
            <div class="card-body">
               <form action="{{ route('tags.store') }}" method="post">
                  ...
                  <div class="row mb-3 align-items-center">
                     <div class="col-2">
                        <label for="name" class="col-form-label-lg">Nama Label <sup class="text-danger">*</sup></label>
                     </div>
                     <div class="col-10">
                        <input type="text"
