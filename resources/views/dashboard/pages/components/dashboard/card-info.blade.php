<div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 @cannot('member') d-flex align-items-center @endcan">
    @cannot('member')
    <div class="row">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <div class="card-info">
                            ...
                            <small class="text-muted">Berita / Pengumumam</small>
                        </div>
                    </div>
                </div>
            </div>
