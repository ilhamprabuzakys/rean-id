               ...
               <div class="col-sm-6">
                  <div class="card">
                     <div class="card-body">
                        ...
                        <div class="mb-0">
                           <span class="badge badge-primary-light"> <i class="mdi mdi-arrow-bottom-right"></i> 6.65% </span>
                           <span class="text-muted">Since last week</span>
                        </div>
                     </div>
                  </div>
                  <div class="card">
                     <div class="card-body">
                        ...
                        <div class="mb-0">
                           ...
                           <span class="text-muted">Sejak minggu kemarin</span>
                        </div>
                     </div>
                  </div>
               </div>
