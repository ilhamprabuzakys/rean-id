                                    ...
                                    <div class="d-flex flex-column h-100">
                                       <div class="mb-1 mb-md-1">
                                          <a href="{{ route('login') }}" class="d-block auth-logo">
                                             <img src="{{ asset('assets/img/rean-berwarna-logo-saja.png') }}" alt="" height="120" class="auth-logo-dark me-start">
            ...
            {{-- <div class="col-xxl-8 col-lg-7 col-md-6">
               <div class="auth-bg bg-white py-md-5 p-4 d-flex">
                  ...
                  <div class="row justify-content-center align-items-center">
                     <div class="col-xl-8">
                        <div class="mt-4">
                           <img src="{{ asset('assets/img/rean-berwarna-logo-saja.png') }}" class="img-fluid" alt="">
                        </div>
