...
@section('page-heading', 'Daftar Postingan')
@section('content')
  <!--begin::Card-->
  <div class="card">
   <!--begin::Card header-->
...
@push('script')
    ...
    <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/custom/apps/ecommerce/customers/listing/listing.js') }}"></script>
    <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/custom/apps/ecommerce/customers/listing/listing/add.js') }}"></script>
    <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/custom/apps/ecommerce/customers/listing/listing/export.js') }}"></script>
    ...
    <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/custom/utilities/modals/users-s
@endpush
