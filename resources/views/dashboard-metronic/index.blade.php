            ...
            <div class="card-header pt-5">
               ...
               <div class="card-toolbar d-none">
                  ...
                  <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left" class="btn btn-sm btn-light d-flex align-items-center px-4">
                     ...
                     <!--end::Display range-->
                     <i class="ki-duotone ki-calendar-8 fs-1 ms-2 me-0"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span
               ...
               <div class="row align-items-center h-100">
                  ...
                  <div class="col-7 ps-xl-13">
                     ...
                     <div class="d-flex flex-column flex-sm-row d-grid gap-2">
                        ...
                        <a href="#" class="btn btn-primary flex-shrink-0" style="background: rgba(255, 255, 255, 0.2)" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Read
                           Guides</a>
                     </div>
                     <!--end::Action-->
                  </div>
            ...
            <div class="card-header pt-5 mb-6">
               ...
               <div class="card-toolbar">
                  ...
                  <button class="btn btn-icon btn-color-gray-400 btn-active-color-primary justify-content-end" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
                     ...
                     <i class="ki-duotone ki-dots-square fs-1 text-gray-300 me-n1"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span
                           class="path4"></span></i>
                  </button>
                  <!--begin::Menu 2-->
            ...
            <div class="card-body py-0 px-0">
               ...
               <ul class="nav d-flex justify-content-between mb-3 mx-9">
                  ...
                  <li class="nav-item mb-3">
                     <!--begin::Link-->
                     <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px active" data-bs-toggle="tab"
                  ...
                  <li class="nav-item mb-3">
                     <!--begin::Link-->
                     <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " data-bs-toggle="tab"
...
@endsection
@push('script')
   <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/index.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/xy.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/percent.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/radar.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/themes/Animated.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/map.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/geodata/worldLow.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/geodata/continentsLow.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/geodata/usaLow.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/geodata/worldTimeZonesLow.js') }}"></script>
   <script src="{{ asset('assets/Metronic/cdn.amcharts.com/lib/5/geodata/worldTimeZoneAreasLow.js') }}"></script>
   <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
   <!--end::Vendors Javascript-->

   <!--begin::Custom Javascript(used for this page only)-->
   <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/widgets.bundle.js') }}"></script>
   <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/custom/widgets.js') }}"></script>
   <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/custom/apps/chat/chat.js') }}"></script>
   <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/custom/utilities/modals/upgrade-plan.js') }}"></script>
   <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/custom/utilities/modals/create-app.js') }}"></script>
   <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/custom/utilities/modals/new-target.js') }}"></script>
   <script src="{{ asset('assets/Metronic/preview.keenthemes.com/metronic8/demo1/assets/js/custom/utilities/modals/users-search.js') }}">
      < /script
   @endpush
