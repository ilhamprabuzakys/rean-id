...
<div class="accordion">
   <div class="card accordion-item">
      <h2 class="accordion-header" id="headingCreateEventForm">
         <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#createEventForm" aria-expanded="false" aria-controls="createEventForm"> <i
               class="fas fa-plus-circle me-2"></i> Buat Event </button>
      </h2>
      {{-- Create or Update Form --}}
      <div id="createEventForm" class="accordion-collapse show" aria-labelledby="headingCreateEventForm" data-bs-parent="#collapsibleSection">
