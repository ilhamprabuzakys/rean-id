         ...
         <form wire:submit.prevent='store'>
            <div class="row">
               ...
               {{-- <div class="col-6 mb-3">
                  <label for="merge_date" class="mb-2">Tanggal Acara <sup class="text-danger">*</sup></label>
                  <div class="input-group">
                     <input type="text" class="form-control @error('merge_date') is-invalid @enderror"
                        wire:model='merge_date' id="merge_date">
                     <span class="input-group-text"><i class="fas fa-calendar-alt text-primary"></i></span>
                     @error('merge_date')
                     <div class="invalid-feedback">
                        {{ $message }}
               ...
               <div class="col-12 mb-5">
                  ...
                  <div wire:ignore>
                     <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                        id="description" rows="4" wire:model='description'></textarea>
                     @error('description')
                     <div class="invalid-feedback">
                        {{ $message }}
                     </div>
