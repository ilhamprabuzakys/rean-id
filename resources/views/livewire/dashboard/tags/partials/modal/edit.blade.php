      ...
      <div class="modal-content">
         ...
         <form wire:submit.prevent="update">
            <div class="modal-body">
               ...
               <span class="d-block text-danger mt-3 text-sm">Dengan <strong>memperbarui</strong> data ini akan membuat semua postingan yang memiliki kategori ini menjadi <strong>diperbarui</strong> pada jenis <strong>kategorinya</strong>.</span>
            </div>
