<li class="nav-item dropdown-notifications navbar-dropdown dropdown me-2 me-xl-1" style="overflow: visible;">
   <a style="overflow: visible;"
      ...
      <span class="position-absolute top-0 start-50 translate-middle-y badge rounded-circle bg-danger mt-2 border"
         style="font-size: 10px">{{ $banyakNotifikasi }}</span>
      @endif
   </a>
   <ul class="dropdown-menu dropdown-menu-end py-0">
      <li class="dropdown-menu-header border-bottom">
         <div class="dropdown-header d-flex align-items-center py-3">
            ...
            @if ($banyakNotifikasi > 0)
            <span class="badge rounded bg-danger me-2" wire:click.prevent='bersihkanNotifikasi()'
               style="cursor: pointer;">Bersihkan notifikasi</span>
            @endif
         </div>
      </li>
      ...
      <li class="dropdown-notifications-list scrollable-container">
         <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
               <a
                  href="{{ isset($notification->properties['link']) ? $notification->properties['link'] : 'javascript:void(0)'}}">
                  <div class="d-flex gap-2">
                     <div class="flex-shrink-0">
                        <div class="avatar me-1">
                           ...
                           @elseif ($notification->event == 'registration')
                           <span class="avatar-initial rounded-circle bg-label-success">
                           ...
                           @elseif ($notification->event == 'global')
                           <span class="avatar-initial rounded-circle bg-label-primary">
