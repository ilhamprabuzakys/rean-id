               ...
               <div class="d-flex mt-4 mb-3">
                  ...
                  <div class="flex-grow-1 row">
                     <div class="col-2">
                        ...
                        @if (auth()->user()->facebook !== null && auth()->user()->facebook !== '')
                     ...
                     <div class="col-10 text-end">
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control @error('facebook') is-invalid @enderror"
                              name="facebook" wire:model='facebook' id="facebook">
                        </div>
                     </div>
                  </div>
               </div>
               <div class="d-flex mb-3">
                  ...
                  <div class="flex-grow-1 row">
                     <div class="col-2">
                        ...
                        @if (auth()->user()->twitter !== null && auth()->user()->twitter !== '')
                        <small class="text-success">Connected</small>
                        @else
                        <small class="text-danger">Not Connected</small>
                        @endif
                     ...
                     <div class="col-10 text-end">
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control @error('twitter') is-invalid @enderror" name="twitter"
                              wire:model='twitter' id="twitter" value="{{ old('twitter', $twitter) }}">
                        </div>
                     </div>
                  </div>
               </div>
               <div class="d-flex mb-3">
                  ...
                  <div class="flex-grow-1 row">
                     <div class="col-2">
                        ...
                        @if (auth()->user()->instagram !== null && auth()->user()->instagram !== '')
                        <small class="text-success">Connected</small>
                        @else
                        <small class="text-danger">Not Connected</small>
                        @endif
                     ...
                     <div class="col-10 text-end">
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control @error('instagram') is-invalid @enderror"
                              name="instagram" wire:model='instagram' id="instagram"
               ...
               <div class="d-flex mb-3">
                  ...
                  <div class="flex-grow-1 row">
                     <div class="col-2">
                        ...
                        @if (auth()->user()->gmail !== null && auth()->user()->gmail !== '')
                        <small class="text-success">Connected</small>
                        @else
                        <small class="text-danger">Not Connected</small>
                        @endif
                     ...
                     <div class="col-10 text-end">
                        <div class="input-group">
                           <input type="text" class="form-control @error('gmail') is-invalid @enderror" name="gmail"
                              wire:model='gmail' id="gmail" value="{{ old('gmail', $gmail) }}">
               ...
               <div class="d-flex">
                  ...
                  <div class="flex-grow-1 row">
                     <div class="col-2">
                        ...
                        @if (auth()->user()->youtube !== null && auth()->user()->youtube !== '')
                        <small class="text-success">Connected</small>
                        @else
                        <small class="text-danger">Not Connected</small>
                        @endif
                     ...
                     <div class="col-10 text-end">
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control @error('youtube') is-invalid @enderror" name="youtube"
                              wire:model='youtube' id="youtube" value="{{ old('youtube', $youtube) }}">
                        </div>
                     </div>
                  </div>
               </div>
               @if($errors->all())
               <div class="mt-4 mb-3 float-start">
                  Pesan kesalahan:
                  <ul class="mt-2">
