<div class="flex-shrink-0 avatar avatar-{{ $receiverInstance->status == 'online' ? 'online' : 'offline' }}">
   @if ($receiverInstance->avatar == null)
   <img src="{{ asset('assets/img/avatar/avatar-1.png') }}" alt="Avatar" class="rounded-circle"
       data-bs-toggle="sidebar" data-overlay data-target="#app-chat-sidebar-right" style="object-fit: cover">
   @else
